            ...
            <div className="Parking-containner">
              ...
              <div className="Button-Park" style={{ margin: '0.2rem' }}>
                <Button
                  ...
                  disabled={parkingData[index]?.isDisabled}
                  className={parkingData[index]?.count < 19 ? 'Buttoning' : 'ReButtoning'}
                  style={{ borderRadius: '5px' ,width: '73px',justifyContent: 'right',textAlign: 'center'}}
                >
